...
import com.umg.controlador.ControladorBancos;
import com.umg.controlador.ControladorBancos;
 ...
 * @author axels
 */
public class VistaBancos extends javax.swing.JPanel {
    ...
    public VistaBancos() {
        initComponents();
         ModeloBancos modelo = new ModeloBancos(this);
        ControladorBancos controlador = new ControladorBancos(modelo);
...
public void setControlador(ControladorBancos controlador) {
