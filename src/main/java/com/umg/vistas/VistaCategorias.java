...
public class VistaCategorias extends javax.swing.JPanel {
    ...
    public VistaCategorias() {
        initComponents();
        ModeloCategoria modelo = new ModeloCategoria(this);
        ControladorCategoria controlador = new ControladorCategoria(modelo);
    ...
    public void setControlador(ControladorCategoria controlador) {
