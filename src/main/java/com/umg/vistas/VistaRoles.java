...
import com.umg.controlador.ControladorRoles;
...
public class VistaRoles extends javax.swing.JPanel {
    ...
    public VistaRoles() {
        initComponents();
        ModeloRoles modelo = new ModeloRoles(this);
        ControladorRoles controlador = new ControladorRoles(modelo);
    ...
    public void setControlador(ControladorRoles controlador) {
