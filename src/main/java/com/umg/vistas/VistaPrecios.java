 ...
 * @author axels
 */
public class VistaPrecios extends javax.swing.JPanel {
    ...
    public VistaPrecios() {
        initComponents();
        ModeloPrecios modelo = new ModeloPrecios(this);
        ControladorPrecios controlador = new ControladorPrecios(modelo);
    ...
    private void initComponents() {
        ...
        cmbOrdenarPor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código Producto", "Aplicación", "Precio Venta", "Inicio Vigencia", "Fin Vigencia" }));
        ...
        tblCategorias.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código Producto", "Aplicación", "Precio Venta", "Inicio Vigencia", "Fin Vigencia"
            }
        ));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 200, 20));
        ...
        jPanel1.add(txtDescripcion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 200, 30));

        txtDescripcion2.setBackground(new java.awt.Color(255, 255, 255));
        txtDescripcion2.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(102, 102, 102)));
        jPanel1.add(txtDescripcion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 200, 30));

        jLabel8.setFont(new java.awt.Font("Skoda Pro", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(33, 37, 41));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel8.setText("Inicio Vigencia");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 200, 20));

        txtDescripcion3.setBackground(new java.awt.Color(255, 255, 255));
        txtDescripcion3.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(102, 102, 102)));
        jPanel1.add(txtDescripcion3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 200, 30));

        jLabel9.setFont(new java.awt.Font("Skoda Pro", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(33, 37, 41));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel9.setText("Fin Vigencia");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 200, 20));
